...
contract Exchange{
    ...
    //check balances 
     ...
     // ------------------------
    // MAKE & CANCEL ORDERS 
    //Token Get token they want to get - wich token and how much
    ///Token give token they want give - wich token and how much
    ...
    function _trade(uint256 _orderId,address _user,address _tokenGet,uint256 _amountGet,address _tokenGive,uint256 _amountGive)internal {
        ...
        // Emit trade event
        //user is the creator,msg.sender is the user the user will takes the order
