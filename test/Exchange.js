...
describe('Exchange', () => {
  ...
  beforeEach(async () => {
    ...
    token1 = await Token.deploy('Mock USD', 'mUSD', '1000000')
    token2 = await Token.deploy('mBNB', 'mBNB', '1000000')
  ...
  describe('Depositing Tokens', () => {
    ...
    describe('failure',()=>{
      it('fails when no tokens are approved',async()=>{
         //Don't approve any tokens before deposisting
  ...
  describe('Withdrawing Tokens', () => {
    ...
    describe('failure',()=>{
      it('fails when inssuficient balance',async()=>{
         //Attempts to withhdraw tokens without deposisting
